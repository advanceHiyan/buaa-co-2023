...
LAB20:    t251 = (t0 + 4384);
    ...
    t255 = *((char **)t254);
    memcpy(t255, t3, 8);
    xsi_driver_vfirst_trans(t251, 0, 31);
    t256 = (t0 + 4176);
    *((int *)t256) = 1;
...
LAB83:    t243 = (t0 + 1048U);
    ...
    t243 = ((char*)((ng1)));
    memset(t250, 0, 8);
    xsi_vlog_unsigned_add(t250, 32, t249, 32, t243, 32);
    goto LAB84;

LAB85:    xsi_vlog_unsigned_bit_combine(t212, 32, t244, 32, t250, 32);
    goto LAB89;

LAB87:    memcpy(t212, t244, 8);
    goto LAB89;
...
extern void work_m_00000000003052973442_0757879789_init()
{
	...
	xsi_register_didat("work_m_00000000003052973442_0757879789", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000003052973442_0757879789.didat");
